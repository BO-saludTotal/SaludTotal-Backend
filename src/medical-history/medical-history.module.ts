...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([
      ClinicalRecordEntry, User, MedicalEventType, HealthEntity,
      PhysicalAttentionSpace, MedicalAppointment, ClinicalRecordDiagnosis,
      DiagnosisCode, Prescription, PrescriptionMedicationDetail,
      CommercialMedicationPresentation, GeneralMedication, ExamResult,
      ExamResultDetail, ExamParameter, ClinicalRecordAttachment
    ]),
  ],
